...
4.  **Good OCLC numbers in your Polaris MARC records**. This process does a CSV match with OCLC. OCLC only supports sycing one OCLC number to one local system number. So, even if there are multiple numbers on the bib, only one will be synced.
